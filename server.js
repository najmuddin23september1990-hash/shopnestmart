...
const starterData = {
  products: [
    ...
    {
      id: "tools-repair-essentials",
      name: "Tools & Repair Essentials",
      category: "Hand tools",
      price: "Ask for current rate",
      image: "wall-hook-5.jpg",
      images: ["wall-hook-5.jpg"],
      description: "Screwdrivers, pliers, hammers, cutters, measuring tools, and daily workshop tools available on inquiry.",
      stock: "Available",
      featured: false,
    },
  ],
